...
El\textbf{ NAS (Network Attached Storage o Almacenamiento Conectado a la Red)} es un dispositivo de almacenamiento especializado que se conecta a la red existente de una organización mediante el protocolo TCP/IP. A diferencia de la SAN, el NAS \textbf{opera a nivel de archivos}, lo que significa que cuenta con su propio sistema operativo y sistema de archivos, y proporciona acceso a los datos a través de protocolos de comparte de archivos como \textbf{CIFS/SMB para sistemas Windows o NFS para sistemas UNIX/Linux}.
...
El ecosistema de FCoE es menos maduro que los de FC e iSCSI. Hay menos proveedores que ofrecen productos FCoE, menos opciones de hardware y menos personal con experiencia en la tecnología. Esto puede resultar en desafíos de compatibilidad y menor competitividad en precios.

FCoE es más adecuado para centros de datos grandes que ya utilizan Fibre Channel pero quieren consolidar su infraestructura de red, o para nuevas implementaciones que quieren la fiabilidad de Fibre Channel con la flexibilidad de Ethernet. Es particularmente atractivo en entornos de virtualización densa donde la reducción de adaptadores y cables en cada servidor es valiosa.