...
% Pendiente: poner imagen mostrando la composicion del header GRE
...
% Pendiente: poner imagen mostrando la composicion del header VXLAN
...
\begin{tabular}{@{}lllll@{}}
\toprule
\textbf{Protocolo} & \textbf{Overhead} & \textbf{Segmentación}  & \textbf{Adopción} \\
\midrule
GRE    & Bajo      & No nativa            & Alta (genérica)      \\
VXLAN  & Moderado  & 24 bits (16M VNIs)   & Muy alta (DC)        \\
GENEVE & Moderado  & 24 bits + metadatos  & Creciente            \\
NVGRE  & Moderado  & 24 bits (VSID)       & Limitada (Microsoft) \\
MPLS   & Bajo      & Por etiqueta/VRF     & Muy alta (operador)  \\
\bottomrule
\end{tabular}
\end{table}
