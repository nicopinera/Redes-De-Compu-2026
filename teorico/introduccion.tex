...
Un datagrama es un tipo específico de paquete de datos que se trata de forma independiente dentro de una red de conmutación de paquetes, sin que exista una conexión previa establecida entre emisor y receptor. Cada datagrama lleva información de control suficiente en su cabecera para que la red pueda encaminarlo desde el origen hasta el destino por sí solo. Este término se asocia generalmente con servicios no orientados a conexión y de "mejor esfuerzo" (best-effort), como es el caso del protocolo IP o UDP
...
\subsection{Circuito Virtual}

Un circuito virtual es una técnica de conmutación de paquetes en la que se establece una conexión lógica y una ruta predefinida a través de la red antes de que comience la transferencia real de datos. Aunque los datos siguen dividiéndose en paquetes, esta técnica emula el comportamiento de un circuito físico dedicado.